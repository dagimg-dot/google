<template>
    <div class="flex border-b">
        <div class="search-type-wrapper flex justify-between items-end mt-1">
            <div class="flex space-x-5 ">
                <a href="#">
                    <div class="flex space-x-1 items-center pb-3">
                        ...
                        <span class="others">All</span>
                    </div>
                </a>
                <a href="#">
                    <div class="others flex space-x-1 items-center">
            ...
            <div class="others tools flex pb-3">
                <a href="#">Tools</a>
            </div>
        </div>
    </div>
